...
class UserSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        user.user_type = user_type # Assign the custom field to the user instance since it is a model serializer 
...
class PropertySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Property
        fields = ['pk','name', 'location_text','price','currency','description','Location','property_types','propertyimages']
